...
and [R template](https://github.com/tool-spec/tool_template_r), but can be mimiced in any container.
...
With the [toolbox-runner](https://github.com/tool-spec/tool-runner) this is simplyfied. Note that this is a Python-only tool, to handle
